...
import com.splanes.apps.skillbook.data.feature.workhistory.repository.WorkHistoryRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    abstract fun bindWorkHistoryRepository(impl: WorkHistoryRepositoryImpl): WorkHistoryRepository
}
